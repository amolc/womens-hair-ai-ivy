...
function playArIntroAnimation() {
    ...
    arIntroInterval = setInterval(function () {
        if (arIntroFrame < arIntroTotalFrames) {
            arIntroImg.src = `assets/Media/ARIntro/ARHair_Intro_${arIntroFrame.toString().padStart(5, '0')}.webp`;
            arIntroFrame++;
        } else {
            stopArIntroAnimation();
            playArIdleAnimation();
...
function playArIdleAnimation() {
    ...
    arIdleInterval = setInterval(function () {
        if (arIdleFrame < arIdleTotalFrames) {
            arIdleImg.src = `assets/Media/ARIdle/ARBear_Idle_${arIdleFrame.toString().padStart(5, '0')}.webp`;
            arIdleFrame++;
        } else {
...
function playArGiftAnimation() {
    ...
    arGiftInterval = setInterval(function () {
        if (arGiftFrame < arGiftTotalFrames) {
            arGiftImg.src = `assets/Media/ARGift/ARBear_Gift_${arGiftFrame.toString().padStart(5, '0')}.webp`;
...
function playArBlowerAnimation() {
    ...
    arBlowerInterval = setInterval(function () {
        if (arBlowerFrame < arBlowerTotalFrames) {
            arBlowerImg.src = `assets/Media/ARBlower/ARBear_Blower_${arBlowerFrame.toString().padStart(5, '0')}.webp`;
...
function playArNailPolishAnimation() {
    ...
    arNailPolishInterval = setInterval(function () {
        if (arNailPolishFrame < arNailPolishTotalFrames) {
            arNailPolishImg.src = `assets/Media/ARNailPolish/ARBear_Nail%20Polish_${arNailPolishFrame.toString().padStart(5, '0')}.webp`;
...
function playArMirrorAnimation() {
    ...
    arMirrorInterval = setInterval(function () {
        if (arMirrorFrame < arMirrorTotalFrames) {
            arMirrorImg.src = `assets/Media/ARMirror/ARHair_Mirror_${arMirrorFrame.toString().padStart(5, '0')}.webp`;
...
function loadAllAnimations() {
    const animations = [
        ...
        { totalFrames: arIntroTotalFrames, path: 'assets/Media/ARIntro/ARHair_Intro_{frame}.webp', target: arIntroImages, name: 'AR Intro Animation' },
        { totalFrames: arIdleTotalFrames, path: 'assets/Media/ARIdle/ARBear_Idle_{frame}.webp', target: arIdleImages, name: 'AR Idle Animation' },
        { totalFrames: arGiftTotalFrames, path: 'assets/Media/ARGift/ARBear_Gift_{frame}.webp', target: arGiftImages, name: 'AR Gift Animation' },
        { totalFrames: arBlowerTotalFrames, path: 'assets/Media/ARBlower/ARBear_Blower_{frame}.webp', target: arBlowerImages, name: 'AR Blower Animation' },
        { totalFrames: arNailPolishTotalFrames, path: 'assets/Media/ARNailPolish/ARBear_Nail Polish_{frame}.webp', target: arNailPolishImages, name: 'AR Nail Polish Animation' },
        { totalFrames: arMirrorTotalFrames, path: 'assets/Media/ARMirror/ARHair_Mirror_{frame}.webp', target: arMirrorImages, name: 'AR Mirror Animation' }
    ];
